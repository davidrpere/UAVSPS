...
if("FALSE" STREQUAL "TRUE")
  set(libmavconn_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-libmavconn-0.21.0)
  set(libmavconn_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-libmavconn-0.21.0/obj-arm-linux-gnueabihf/devel)
...
if(NOT "include;/usr/include;/opt/ros/kinetic/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libmavconn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'Vladimir Ermakov <vooon341@gmail.com>' to fix it.")
    endif()
