...
if("FALSE" STREQUAL "TRUE")
  set(mavros_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-mavros-0.21.0)
  set(mavros_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-mavros-0.21.0/obj-arm-linux-gnueabihf/devel)
...
if(NOT "include;/usr/include;/usr/include/eigen3;/usr/lib/../include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mavros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'Vladimir Ermakov <vooon341@gmail.com>' to fix it.")
    endif()
